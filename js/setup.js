...
const generatePlayCols = (x, y) => {
    ...
    if (y == 0 && x == 5)
        return genCol(40);
    if (y < 2 && x < 2)
        return genHomeCols("green");
    if (y < 2 && x > 8)
        return genHomeCols("red");
    if (y > 8 && x < 2)
    ...
    for (var y = 0; y < 11; y++) {
        for (var x = 0; x < 11; x++) {
            ...
            if (pDiv == null) {
                ...
                field === null || field === void 0 ? void 0 : field.appendChild(d);
            }
            else {
                field === null || field === void 0 ? void 0 : field.appendChild(pDiv);
            }
        }
    }
};
const colors = { "red": 0, "blue": 0, "black": 0, "green": 0 };
const genHomeCols = (color) => {
    const el = document.createElement("div");
